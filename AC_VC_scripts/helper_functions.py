...
def analyse_template_switches(proj_path):
    """function to look at combined dataframe showing template switching events and to calculate AT content and entropy of the sequences versus 1st/2nd max counts"""
    switching_tab = pd.read_pickle(
        f"{proj_path}/supplementary_tables/switching_tab_combined.pkl"
    )
